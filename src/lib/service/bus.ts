...
export const fetchBusStopData = async () => {
    ...
    function callLine(call: any) {
        ...
        const displayname = call.serviceJourney.journeyPattern.line.name + " " + call.destinationDisplay.frontText;
        const timeStr = expectedDepartureTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false });
